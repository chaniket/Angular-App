...
const routes: Routes = [
  ...
  { path: 'reactive-dashboard', component: ReactiveDashboardComponent },
  { path: '', component: ReactiveDashboardComponent },
  { path: 'reactive-form', component: ReactiveFormComponent },
  { path: 'user-report/:id', component: UserReportComponent },
  { path: 'boostrap/:id', component: AddBootstrapSessionComponent },
  { path: 'input-output/:item', component: InputOutputComponent },
